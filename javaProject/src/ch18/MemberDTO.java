...
//MVC패턴에서 쓰이는 용어
//1)Data Transfer Object(데이터를 전달하는 객체, 결과물을 저장)
//2)VO : Value Object, DTO의 개념이지만 생성자없이 getter setter로만 구성됨
//3)DAO : Data access object(데이터 조작 객체, db와 연결해 데이터를 구하는 비즈니스 로직단)
...
public class MemberDTO implements Serializable {
	...
	@Override
	public String toString() {//참조변수로 확인 가능 
