...
public class WrapperEx2 {
	public static void main(String[] args) {
		//character
		System.out.println(Character.toLowerCase('A')); //A를 소문자로 변경해줌
		char c1='4', c2='F';
		...
		//Integer
		System.out.println(Integer.parseInt("200"));//문자열을 10진수로 변환
		System.out.println(Integer.toString(200)); //정수를 문자열로 변환
